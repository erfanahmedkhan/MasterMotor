                    ...
                    <div
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control bg-white" name="" id="test" style="font-size: 12px;">
                                <option disabled selected hidden> Select DSSI Status </option>
                                <option> Done </option>
                ...
                <table class="example table table-striped table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td> 12/2/2023 </td>
                            <td> csi </td>
                            <td class="view" data-toggle="modal" data-target=".bd-example-modal-xl"
                                title="View Vehicle Details"> Done </td>
                            <td> 12/2/2023 </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td> warranty </td>
                            <td class="view" data-toggle="modal" data-target=".bd-example-modal-xl"
                                title="View Vehicle Details"> Not Done </td>
                            <td> 12/5/2023 </td>
                            <td>
                                <select style="border: none; background-color: transparent; font-size: 12px;" name=""
                                    id="">
                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" id="largeModalLabel"> DSSI Survey </h3>
